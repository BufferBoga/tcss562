...
callservice(){
  ...
  do
    ...
    output=`bx wsk action invoke --result diskio --param cacls 1000`
    #output=${output%?};
    # grab end time
    #time2=200
    ...
    vuptime=`echo $output | jq '.vuptime'`
    ...
    echo "$i,$threadid,$uuid,$cputype,$cpusteal,$vuptime,$cpuusr,$cpukrn,$elapsedtime,$newcont"
